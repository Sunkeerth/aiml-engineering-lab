...
""" take an input list find the first the square of each element and then find the product of it ."""
...
#         p=p*i
#     print(p)
# dof=power_of(get_product)
# lst=[1,2,3,4,5,6,7,8,9]
# dof(lst)

# simple way is add or call using @ function 
